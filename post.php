...
<div id="single">
    <div id="top">
        ...
        <a class="" href="javascript:history.back()">
            <img  style="width: 33px; margin-top: 5px;margin-left: 20px;" src="<?php $this->options->themeUrl('images/favicon.ico'); ?>">
        </a>
            ...
            <div>
                ...
                <div class="content">
                    ...
                    <audio class="wp-audio-shortcode" id="audio-<?php $this->cid(); ?>-1" loop="1" preload="auto" style="width: 100%;" controls="controls">
                        <source type="audio/mpeg" src="http://music.163.com/song/media/outer/url?id=<?php if($this->fields->music) $this->fields->music(); else 29045492; ?>.mp3" />
                    </audio>
